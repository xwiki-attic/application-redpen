...
public class RedPenConfigClassDocumentConfigurationSource extends AbstractDocumentConfigurationSource
{
    ...
    private static final String SPACE_NAME = "Redpen Checker";
    ...
    {
        return new DocumentReference(CONFIG_DOCUMENT_REFERENCE, getCurrentWikiReference());
    }

    @Override
    protected LocalDocumentReference getClassReference()
    {
        return CONFIG_XCLASS_REFERENCE;
    }

    @Override
    protected String getCacheId()
    {
        return "configuration.document.content.checker";
    }
}
